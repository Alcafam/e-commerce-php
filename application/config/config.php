...
|
*/
$config['base_url'] = "https://ci-ecommerce.devalca.site/";
...
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 0;
$config['sess_save_path'] = '/tmp';  // Or FCPATH . 'sessions'
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
/*
...
*/
if (stripos($_SERVER["REQUEST_URI"],'/users/login_process') === TRUE || stripos($_SERVER["REQUEST_URI"],'/registration/registration_process')||stripos($_SERVER["REQUEST_URI"],'/add_to_cart')) {
